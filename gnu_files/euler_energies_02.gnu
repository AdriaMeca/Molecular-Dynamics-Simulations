...
set output "../figures/euler_energies_02.tex"

file = "../data/thermodynamics_01_04.dat"
...
set obj rect \
  at screen plot_left+plot_width+xsep/2,0.95 size char strlen('dt=10-3r.u.'),char 1 \
  fc rgb "gray"
set label '$\delta t=10^{-3}\unit{r.u.}$' \
...
plot file u 1:3 w p ps 0.5 lc 1 lw 2 notitle
...
set yrange [10**3:10**31]
set ytics 10**5,10**5,10**30

set ylabel 'Energy$\,(\epsilon)$'

plot file u 1:2 w p ps 0.5 pt 2 lc 2 lw 2 notitle, NaN w p pt 2 lc 2 lw 2 t '$K$',\
     file u 1:($2+$3) w l lc 3 lw 3 notitle, NaN w l lc 3 lw 2 t '$E$'
...
set ytics 1.8,0.2,2.2
set ytics format '%.1f'

set ylabel '$P\,(10^{2}\sqrt{m\epsilon})$'

plot file u 1:(10**-2*$4) w l lc 4 lw 3 notitle
