...
set output "../figures/vel_verlet_energies_02.tex"

file = "../data/thermodynamics_01_02.dat"
...
plot file u 1:(10**-3*$3) w l ls 1 notitle
...
plot file u 1:(10**-4*$2) w l ls 2 notitle, NaN w l ls 2 lw 2 t '$K$',\
